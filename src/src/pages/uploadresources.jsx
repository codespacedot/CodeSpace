...
import { fileSize, resourceSuccess } from "../constants";
...
function UploadResources() {
  ...
  useEffect(() => {
    if (selectedSem !== 0 && selectedSem !== "Select Semester") {
      axios
        .get(
          `${REACT_APP_CS_API}/api/academics/subjects?semester=${selectedSem}`,
          {
  ...
  const addResources = () => {
    if (
      ...
      apiData.append(
        "title",
        selectedCategory === "exam" ? examTitle : fileTitle
      );
      axios
        .post(`${REACT_APP_CS_API}/api/academics/resources/upload`, apiData, {
          headers: {
      ...
      {userToken === null ? (
        ...
        <div>
          ...
          <section className="form" id="form">
                    ...
                    <>
                      ...
                      <div className="col-12 col-xl-8 col-lg-8 col-md-12 col-sm-12 bottom">
                        <div className="form-outline ">
                          ...
                          />
                           <h4 style={{float:'right',fontSize:15, color:'#7d7d7d',marginTop: 5}}><span>*</span> max size 50 MB</h4>
                          <div className="invalid-feedback">
                            Please provide a file.
                          </div>
                        </div>
            ...
            {toastVisible && toastMessage === resourceSuccess ? (
              <div>
                <Toast
                  open={toastVisible}
            ...
            toastVisible && toastMessage === fileSize ?(
              <div>
                <Toast
                  open={toastVisible}
                  backgroundColor="#e00"
